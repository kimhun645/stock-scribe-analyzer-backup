...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://stock-6e930.web.app');
...
try {
  admin.initializeApp({
    ...
    databaseURL: "https://stock-6e930-default-rtdb.firebaseio.com"
  });
...
// Global auth middleware for all /api routes except health
...
app.get("/api/movements", (req, res) => {
  res.json({ 
    ...
    user: req.user,
    data: [
      { id: 1, product: "Product A", quantity: 10, date: "2025-01-09" },
      { id: 2, product: "Product B", quantity: 5, date: "2025-01-09" }
    ]
  });
});
